...
Qwen2.5-Coder-7B / DeepSeek-Coder-6.7B × RunBugRun / CodeARC × seeds 1701/1702/1703.
Each cell includes cache, report, predictions, binding and completion receipts.
Original paths in provenance refer to the old host, and are intentionally preserved.
