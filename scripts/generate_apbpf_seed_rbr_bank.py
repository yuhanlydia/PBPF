...
def main():
    ...
    p.add_argument('--family', choices=['seed_coder_8b'], default='seed_coder_8b')
    ...
    for i, row in enumerate(rows):
        ...
        inputs = tokenizer(prompt, add_special_tokens=False, return_tensors='pt', return_token_type_ids=False).to(model.device)
